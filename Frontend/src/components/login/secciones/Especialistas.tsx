...
export default function Especialistas() {
    ...
    return (
        <>
            ...
            <div className="max-w-full mx-auto md:p-4 py-0 px-0 flex flex-col gap-4 ">
                <div className="flex flex-col md:flex-row gap-4 md:gap-0 justify-between items-center ">
                    <h2 className="text-3xl font-semibold capitalize ">Especialistas</h2>
                    <div className="flex justify-end">
                        <button
                            className="bg-primary text-white px-6 py-2 rounded hover:bg-primary/90 transition cursor-pointer"
                            onClick={() => {

                        ...
                        <ul>
                            {
                                formData.map(({ id, nombre, referencia }) => (
                                    <li key={id} className="flex gap-4 items-center px-3 py-3 rounded-2xl hover:bg-primary/90  transition duration-300 ease-in-out w-fit cursor-pointer max-w-full text-primary hover:text-white" onClick={() => handleClickCopy({ text: referencia, mensaje: `Se ha copiado ${referencia}` })}>

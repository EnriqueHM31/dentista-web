...
export default function SectionEspecialistas() {
    return (
        <motion.section className="min-h-screen flex flex-col items-center justify-center max-w-10/12 w-full mx-auto py-5 xl:py-10 px-1 md:px-10 lg:px-20 xl:px-0 gap-4"
        ...
        >
            ...
            <motion.div className="flex flex-col items-center justify-center py-15 overflow-x-hidden w-full"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }} transition={{
                    duration: 0.3,
                    ease: "easeOut",
